...
// Pin the updated batching logic with pagination
replace github.com/aws/karpenter-provider-aws => github.com/jonathan-innis/karpenter-provider-aws v0.13.2-0.20250701010532-38d917d36a38
